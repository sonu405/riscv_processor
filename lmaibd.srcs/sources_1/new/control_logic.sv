...
output logic [1:0] ALUOp, ImmSrc, ResultSrc, PCSrc);
...
always_comb begin
    case (opcode)        // R type
        ...
        7'b1100011: begin   // B type
            ...
            if (Zero)
                PCSrc = 2'b01; // only when the instruction is B type and alu's Zero bit is 1
        end
        7'b1101111:begin       // J Type
            ...
            ImmSrc = 2'b11;
            ResultSrc = 2'b10; // write PC+4 to register file
            PCSrc = 2'b01;      // take PCTarget as PCNext 
        end        
    endcase
end
endmodule
